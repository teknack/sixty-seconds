	 <?php
include '../connect.php';
$sql="SELECT * FROM level4 WHERE tk_emailid ='dumy'";
...
<html>
	...
	<body onload="init()">
		...
		<div class="exampleoverlay">
			...
			<div class="links">
			 <h1><a href="../ultimatelevel5/Rules/rules.html"  alt="next level">Next Level</a></h1> 
			 <h1><a href="../level4.html" alt="next level">Retry</a></h1>  
			</div>
