...
body{
 ...
 <audio id="boom"> <source src=" TimeBomb.wav" type="audio/ogg "></audio>
 <audio id="boom2"> <source src=" boom.wav" type="audio/ogg "></audio>
...
var audbomb =document.getElementById('boom');
var audbomb2 =document.getElementById('boom2');
