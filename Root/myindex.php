...
<section id = "intro">
  ...
  <li>
  <a href = "#slide1"> <img src = "assets/img/1.png"
...
<div class = "w3-container">
  <br> Survive the longest and show the world(What's left of it) who'
    ...
    <br><br>
     <div id="leadlink"> <a href="../leader/lead.phpassets" alt="Contact Akash Gund" > <b>Survivors</b> </a> </div>
    </div> </div>
    </div>
